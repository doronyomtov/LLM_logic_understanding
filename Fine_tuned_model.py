...
results_df.to_csv('finetuned_model_evaluation_results_with_confidence.csv', index=False)
...
try:
    ...
    plt.ylabel('Count')
    plt.grid(alpha=0.3)
    plt.savefig('confidence_distribution_finetuned.png')
    print("\nConfidence distribution histogram saved to 'confidence_distribution_finetuned.png'")
except ImportError:
